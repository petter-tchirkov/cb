<template>
  <div class="p-5">
    ...
    <div class="flex gap-3 mb-2">
      <ui-button label="Оберіть файли" @click="open()" />
      <ui-button label="Віміна" color="light" :disabled="!files" @click="reset()" />
      <ui-button label="Завантажити" :disabled="!files" @click="uploadFile" />
    </div>

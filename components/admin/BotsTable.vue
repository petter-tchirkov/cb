  ...
  <div class="relative">
    <div class="flex flex-col">
      <div class="flex items-end justify-center w-full gap-10 mb-5">
        <ui-input v-model="search.contract" class="grow" label="Пошук по договору" type="text">
          <template #icon>
        ...
        <ui-select v-model="selected" :options="selectedOptions" title="Статус верифікації" />
        <div class="flex gap-3">
          <ui-button color="success" title="Завантажити" @click="adminStore.updateBots(updatedBots)">

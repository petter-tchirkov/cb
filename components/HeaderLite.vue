<template>
  <header class="flex items-center justify-between px-5 py-2 border-b border-b-gray-200">
    ...
    <div class="flex items-center gap-5">
      ...
      <div class="relative flex items-center justify-center w-10 h-10 text-xl font-medium text-white bg-blue-500 rounded-full
        cursor-pointer" :class="{ 'has-notifications': isNotification }" @click="isNotification = !isNotification">

    ...
    <section class="w-full">
        ...
        <div class="flex flex-col items-center p-5">
            <div class="flex items-center justify-center w-full gap-10">
                ...
                <ui-button label="Відфільтрувати" @click="filterData" class="mt-[8px]"/>
            </div>
            <ui-table
            ...
            <p class="flex items-center mt-5">Всього витрачено:&nbsp;
                <Icon name="ic:baseline-euro" class="w-5 h-5"/>
                <span class="text-xl font-semibold">{{costsStore.totalCharged}}</span>
            </p>
            <div class="flex gap-3 mt-5">
                <ui-table-pagination v-if="!filterParams.show_all" :current-page="filterParams.page" :per-page="filterParams.per_page"  :total-pages="costsStore.pages" @next-page="nextPage" @previous-page="previousPage" @update="(page) => goToPage(page)"/>
